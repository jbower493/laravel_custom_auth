...
Route::post('/api/list/{id}/add-item-by-name', [ListController::class, 'addItemByName'])->middleware('auth:web');
...
Route::post('/api/recipe/{id}/add-item-by-name', [RecipeController::class, 'addItemByName'])->middleware('auth:web');
